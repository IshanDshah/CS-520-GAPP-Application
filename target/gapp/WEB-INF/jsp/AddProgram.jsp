...
<body>
	...
	<br>
	<br>
	<form:form modelAttribute="program" post="AddProgram.html">
		<div class="form-group">
			<label for="usr">Program Name:</label> <input type="hidden"
				value="${department.departmentId}"> <input type="hidden"
				name="programid" value="${program.programId}" path="programId">
			<form:input type="text" class="form-control" path="programName"
				style="width: 25%" />
		</div>
